...
/**
 * Represents the iterator class that will traverse a given 2D array spirally
 * clockwise starting at the top left element.
 * 
 * @author Ahmed Semih Özmekik
 */

public class IteratorSpiral implements Iterator<Integer> {
    ...
    /**
     * Finds the indices and stores them in indices array. Those indices array will
     * be used to iterate the array spirally later on. Pre-Condition: parameter way
     * must be RIGHT=0. Boundary[size=4] array should consist proper
     * limits-boundaries for each 4 positions regarding to data[][] array.
     * 
     * @param way      is the starting direction. Should be RIGHT=0 literal in call.
     * @param boundary is boundary, must only have 4 elements which represents the
     *                 direction.
     */
